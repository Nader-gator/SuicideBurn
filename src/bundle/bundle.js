...
var newGame = function newGame(e) {
  ...
  var textEl = document.getElementById('layer4').focus();
...
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app */ "./src/app.js");
/* harmony import */ var _high_scores_utl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./high_scores_utl */ "./src/high_scores_utl.js");
/* harmony import */ var _predictor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./predictor */ "./src/predictor.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/***/ "./src/high_scores_utl.js":
/*!********************************!*\
  !*** ./src/high_scores_utl.js ***!
  \********************************/
/*! exports provided: fetchCodes, postCodes, checkIfScoreIsgood, produceUl, generateHighScoreForm, createForm, clearForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchCodes", function() { return fetchCodes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "postCodes", function() { return postCodes; });
...
var checkIfScoreIsgood = function checkIfScoreIsgood(score, scores) {
  var arr = [];
  Object.values(scores).forEach(function (el) {
    arr.push(el.score);
  });
...
var produceUl = function produceUl(scoresArray, rank, score) {
  var ul = document.getElementById('high-score-name');
  var sul = document.getElementById('high-score-score');
  var placed = false;
  ...
  scoresArray.forEach(function (el, i) {
    ...
    li.appendChild(document.createTextNode("".concat(el.name)));
    ul.appendChild(li);
    sli.appendChild(document.createTextNode("".concat(el.score)));
    sul.appendChild(sli);
...
var createForm = function createForm(ul, score) {
  ...
  my_form.onsubmit = function (e) {
    e.preventDefault();
    postCodes(document.getElementById('name').value, score);
  };
...
var predictPath = function predictPath(ship, surface) {
  ...
  var x = ship.boardX;
  var y = ship.boardY;
  var hSpeed = ship.hSpeed;
  var vSpeed = ship.vSpeed;
